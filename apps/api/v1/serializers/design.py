...
class DesignRequestListSerializer(TenantModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'checked_out_by', 'checked_out_at', 'checked_out_by_name',
            'has_ard', 'has_pdf', 'has_eps', 'has_dxf', 'has_samples',
            'pallet_configuration', 'created_at',
        ]
        read_only_fields = ['checked_out_by', 'checked_out_at']
...
class DesignRequestSerializer(TenantModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['file_number', 'generated_item', 'checked_out_by', 'checked_out_at', 'created_at', 'updated_at']
