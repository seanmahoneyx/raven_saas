...
@throttle_classes([])  # Exempt from the global anon/user rate limits: probes
# (Docker healthcheck, DO/uptime monitors) hit this every few seconds and would
# otherwise blow past `anon: 100/hour` and get 429'd, marking the app unhealthy.
