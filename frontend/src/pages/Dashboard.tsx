  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Welcome back to Raven SaaS</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <CardDescription>Sales & purchase orders</CardDescription>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-sm text-muted-foreground">
              Connect to the API to see recent activity.
            </div>
          </CardContent>
        </Card>
